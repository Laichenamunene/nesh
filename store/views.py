...
def hotel_view(request):
        ...
        return render(request, 'store/hotel.html', context)
...
def visa_view(request):
        ...
        return render(request, 'store/visa.html', context)

   

def travelblogs_view(request):
        ...
        return render(request, 'store/travelblogs.html', context)
